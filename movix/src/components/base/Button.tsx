...
// ปุ่มที่ใช้ซ้ำได้หลายที่ในแอป
// ขนาด: xs, sm, md, lg
// รูปแบบ: primary, secondary, danger, underfined
// children: เนื้อหาภายในปุ่ม
...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = `font-semibold rounded-lg w-fit whitespace-normal break-words`; //focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-opacity-75 transition-all duration-150 ease-in-out border disabled:opacity-60 disabled:cursor-not-allowed`;
